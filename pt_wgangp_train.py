...
class Trainer(object):
    def __init__(self, netG, netD, train_loader, test_loader=None, cv_loader=None, gpus=()):
        ...
        # self.train_losses_dic = {'G': [], 'D': [], 'GP': [], "SGP": [], 'WD': [], 'GN': [], 'JC': [], 'PSNR': []}
        # self.valid_losses_dic = {'G': [], 'D': [], 'WD': [], 'JC': [], 'PSNR': []}
    ...
    def _dis_train_iteration(self, input, fake, real):
        ...
        self.opt_d.step()
        #
        # self.train_losses_dic["D"].append(loss_d.detach())
        # self.train_losses_dic["WD"].append(w_distance.detach())
        # self.train_losses_dic["GP"].append(gp.detach())
        # self.train_losses_dic["SGP"].append(sgp.detach())
        # self.watcher.scalars(["D", "GP", "WD", "SGP"], self.train_losses_dic, self.count, tag="Train")
    ...
    def _gen_train_iteration(self, input):
        ...
        # self.train_losses_dic["PSNR"].append(psnr)
        # self.train_losses_dic["JC"].append(jc.detach())
        # self.train_losses_dic["G"].append(loss_g.detach())
        # self.watcher.scalars(["PSNR", "JC", "G"], self.train_losses_dic, self.count, tag="Train")
